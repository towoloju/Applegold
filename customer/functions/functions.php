...
function add_cart(){
    ...
    if(isset($_GET['add_cart'])){
        ...
        if(mysqli_num_rows($run_check)>0){
            ...
            $insert = "insert into cart (p_id,ip_add,quantity,price,model,name) values ('$p_id','$ip_add','$p_quantity','$price','$p_model','$pro_name')";
            ...
            <div class='zoom-container'>
                ...
                <div class='xzoom-description'>
                    ...
                    <div class='price-detail'>
                        <p>Price : <span class='pull-right'>&#8358; $pro_price</span></p>
                    </div>
        ...
        while($row_products=mysqli_fetch_array($run_product)){
            ...
            echo"
                <div class='about-us'>
                    <h2>$title</h2>
                    <p>$stmt</p>
                    <a href='#' class='btn btn-info js-scroll-brands'>Discover our Brand</a>
                </div>
